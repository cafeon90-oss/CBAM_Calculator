...
### Q1. 일부 보고서는 POSCO 2026년 부담을 톤당 €70 안팎으로 제시하는데, 도구는 €1~2/t인 이유는?

본 도구는 **EU 공식 수식** `(SEE − benchmark) × phase-in × EUA`을 사용합니다. 2026년 phase-in은 2.5%라서 POSCO(SEE 2.127, benchmark 1.370)는 톤당 €1~2 수준입니다. 일부 보고서는:
- (a) Phase-in 100% 기준으로 환산 (2034 도달 시점)
- (b) Free benchmark 차감 없이 전체 SEE × EUA
- (c) 최종 확정 전 benchmark(1.30) 사용

이렇게 다른 방법론을 쓰는데, **연도별 재무 계획에는 본 도구의 EU 공식 산법이 정확**합니다. 분석 연도를 2034년(phase-in 100%)으로 바꾸면 톤당 €60~70 수준으로, 보고서 수치와 비슷해집니다.
